    ...
    namespace GameUtils {
        ...
        public class YCUpdatesHandler {
            ...
            public static Dictionary<UpdatePackageType, PackageData> PACKAGES = new Dictionary<UpdatePackageType, PackageData>() {
                {UpdatePackageType.Amazon, new PackageData("1.8.0", "Amazon_APS_") },
                {UpdatePackageType.Firebase, new PackageData("12.0.0", "FirebaseAnalytics_") },
                {UpdatePackageType.Prod_Networks, new PackageData("1.1.0", "ProdNetworks_") },
                {UpdatePackageType.Rate_Popup, new PackageData("1.0.0", "RatePopup_") },
            };
            ...
            public static void UpdatePackage(UpdatePackageType packageType) {
                ...
                string downloadURL = PACKAGES_URL + fileName;
            ...
            public struct PackageData {
                ...
                public PackageData(string version, string filePrefix) {
